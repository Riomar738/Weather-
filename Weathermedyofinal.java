...
package weathermedyofinal;
  ...
  import java.time.LocalDateTime; //use to display the current date and time
...
public static boolean status = true ; // boolean a logical data type that checks or represent if the statement is true 
